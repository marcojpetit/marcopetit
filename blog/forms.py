...
class BaseEntradaFormulario(forms.Form):
    ...
    etiquetas = forms.ModelMultipleChoiceField(queryset=Etiqueta.objects.all(), widget=forms.CheckboxSelectMultiple(attrs={'class': "check_box_marco"}), required=False, label="Seleccione las etiquetas")
