...
class BaseEntradaFormulario(forms.Form):
    id_categoria = forms.ModelChoiceField(queryset=Categoria.objects.all(), label="Por favor seleccione una categoría", widget=forms.Select(attrs={'class': "input__field cf-validate"}))
